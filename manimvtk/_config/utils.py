...
from manimvtk import constants
from manimvtk.constants import RendererType
from manimvtk.utils.color import ManimColor
...
if TYPE_CHECKING:
    ...
    from manimvtk.typing import StrPath, Vector3D
...
class ManimConfig(MutableMapping):
    ...
    .. code-block:: pycon
        ...
        >>> from manimvtk import config as global_config
    ...
    def renderer(self, value: str | RendererType) -> None:
        ...
        try:
            ...
            from manimvtk.mobject.opengl.opengl_vectorized_mobject import OpenGLVMobject
    ...
    def get_dir(self, key: str, **kwargs: Any) -> Path:
        ...
        .. code-block:: pycon
            ...
            >>> from manimvtk import config as globalconfig
