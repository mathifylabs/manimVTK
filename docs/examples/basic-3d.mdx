...
<iframe
  src="https://mathify.dev/share/295ec9a9-91f8-4981-898e-6d77024fe788/vtk"
  width="100%"
  height="500"
...
<iframe
  src="https://mathify.dev/share/c7e76bd3-d2fe-4d3d-9dc6-8ea14024a1b4/vtk"
  width="100%"
  height="500"
  style={{ border: "none", borderRadius: "12px" }}
/>
...
<iframe
  src="https://mathify.dev/share/49cc0ee3-e1aa-4f1c-88f2-4a66bfe148b6/vtk"
  width="100%"
  height="500"
  style={{ border: "none", borderRadius: "12px" }}
/>
...
<iframe
  src="https://mathify.dev/share/71d394b2-87f3-4268-b8a1-f8b46aba4b41/vtk"
  width="100%"
  height="500"
  style={{ border: "none", borderRadius: "12px" }}
/>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="cube"
    href="/api-reference/mobjects/3d-objects"
  >
