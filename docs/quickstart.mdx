...
<AccordionGroup>
  <Accordion icon="ubuntu" title="Debian/Ubuntu (including Google Colab)">
    ```bash
...
<Card
  title="See all CLI options"
  icon="terminal"
  href="/advanced/cli-options"
>
...
<AccordionGroup>
  ...
  <Accordion icon="question" title="Need help?">
    Check the [Manim Community](https://www.manim.community/) resources and Discord
  </Accordion>
